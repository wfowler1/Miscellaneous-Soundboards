...
public class ChangeAudioImportSettings : ScriptableObject {
	...
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Toggle audio compression/Disable")]
	static void ToggleCompression_Disable() {
		SelectedToggleCompressionSettings(AudioImporterFormat.Native);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Toggle audio compression/Enable")]
	...
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/32")]
	static void SetCompressionBitrate_32kbps() {
		SelectedSetCompressionBitrate(32000);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/64")]
	static void SetCompressionBitrate_64kbps() {
		SelectedSetCompressionBitrate(64000);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/96")]
	static void SetCompressionBitrate_96kbps() {
		SelectedSetCompressionBitrate(96000);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/128")]
	static void SetCompressionBitrate_128kbps() {
		SelectedSetCompressionBitrate(128000);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/144")]
	static void SetCompressionBitrate_144kbps() {
		SelectedSetCompressionBitrate(144000);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/156 (default)")]
	static void SetCompressionBitrate_156kbps() {
		SelectedSetCompressionBitrate(156000);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/160")]
	static void SetCompressionBitrate_160kbps() {
		SelectedSetCompressionBitrate(160000);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/192")]
	static void SetCompressionBitrate_192kbps() {
		SelectedSetCompressionBitrate(192000);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/224")]
	static void SetCompressionBitrate_224kbps() {
		SelectedSetCompressionBitrate(224000);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Set audio compression bitrate (kbps)/240")]
	...
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Toggle 3D sound/Disable")]
	static void Toggle3DSound_Disable() {
		SelectedToggle3DSoundSettings(false);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Toggle 3D sound/Enable")]
	...
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Toggle mono/Auto")]
	static void ToggleForceToMono_Auto() {
		SelectedToggleForceToMonoSettings(false);
	}
 
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Toggle mono/Forced")]
	static void ToggleForceToMono_Forced() {
		SelectedToggleForceToMonoSettings(true);
	}
 
	// ----------------------------------------------------------------------------
	 [MenuItem ("Utilities/Multi-Edit Audio Clips/Hardware Decoding/Enabled")]
	static void enable_Hardware_yes() {
		enableHardwareDecoding(true);
	}
	[MenuItem ("Utilities/Multi-Edit Audio Clips/Hardware Decoding/Disabled")]
