...
public static class GUIF {
	...
	public static bool RepeatButton(Rect area, string str, System.Action action) { if(RepeatButton(area, str, defaultPadding, "MenuSelect")) { action(); return true; } return false; }
	public static bool RepeatButton(Rect area, string str, string sound, System.Action action) { if(RepeatButton(area, str, defaultPadding, sound)) { action(); return true; } return false; }
	public static bool RepeatButton(Rect area, string str, float padding, System.Action action) { if(RepeatButton(area, new GUIContent(str), padding, "MenuSelect")) { action(); return true; } return false; }
	public static bool RepeatButton(Rect area, string str, float padding, string sound, System.Action action) { if(RepeatButton(area, new GUIContent(str), padding, sound)) { action(); return true; } return false; }
	public static bool RepeatButton(Rect area, GUIContent c, System.Action action) { if(RepeatButton(area, c, defaultPadding, "MenuSelect")) { action(); return true; } return false; }
	public static bool RepeatButton(Rect area, GUIContent c, float padding, System.Action action) { if(RepeatButton(area, c, padding, "MenuSelect")) { action(); return true; } return false; }
	public static bool RepeatButton(Rect area, GUIContent c, float padding, string sound, System.Action action) { if(RepeatButton(area, c, padding, sound)) { action(); return true; } return false; }
	public static bool RepeatButton(Rect area, string str) { return RepeatButton(area, str, defaultPadding, "MenuSelect"); }
	public static bool RepeatButton(Rect area, string str, string sound) { return RepeatButton(area, str, defaultPadding, sound); }
	public static bool RepeatButton(Rect area, string str, float padding) { return RepeatButton(area, new GUIContent(str), padding, "MenuSelect"); }
	public static bool RepeatButton(Rect area, string str, float padding, string sound) { return RepeatButton(area, new GUIContent(str), padding, sound); }
	public static bool RepeatButton(Rect area, GUIContent c) { return RepeatButton(area, c, defaultPadding, "MenuSelect"); }
	public static bool RepeatButton(Rect area, GUIContent c, float padding) { return RepeatButton(area, c, padding, "MenuSelect"); }
